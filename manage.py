...
def create_tables():
    ...
    db.create_all()
    paciente=Pacientes(nombre="Bartolomé", apellidos="Vich Lozano", dni="40123123E", telefono1="971000000", telefono2="871000000")
    db.session.add(paciente)
    paciente2=Pacientes(nombre="Javier", apellidos="Cuenca Valdomero", dni="44123123X", telefono1="971111111", telefono2="871111111")
    db.session.add(paciente2)
    paciente3=Pacientes(nombre="Pepe", apellidos="Gotera Tubería", dni="45123123R", telefono1="971222222", telefono2="871222222")
    db.session.add(paciente3)
    paciente4=Pacientes(nombre="Juan Carlos", apellidos="Albertí Gómez", dni="46123123T", telefono1="9713333333", telefono2="8713333333")
